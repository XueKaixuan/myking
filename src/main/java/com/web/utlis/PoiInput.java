...
public class PoiInput {
    public static List getTestList03(MultipartFile filename){
        try {
            /**
    ...
    public static List getTestList07(MultipartFile filename){
        try {
            /**
             * 从springMVC上传上来的文件中获取到输入流
             */
            ...
            aa:for(int x=2;x<=num;x++){
                 ...
                 * 分值，装进去
                 */
                double fenzhi = row.getCell(5).getNumericCellValue();
                exam.setEfenzhi(fenzhi);
                ...
                if("单选题".equals(value)){
                    String xxA = row.getCell(6).getStringCellValue();
                    String xxB = row.getCell(7).getStringCellValue();
                    String xxC = row.getCell(8).getStringCellValue();
                    String xxD = row.getCell(9).getStringCellValue();
